...
ratings_base = pd.read_csv('dataset/ub.base', sep='\t', names=r_cols, encoding='latin-1')
ratings_test = pd.read_csv('dataset/ub.test', sep='\t', names=r_cols, encoding='latin-1')
...
rs = BMF(Y_data=rate_train, K = 10, lam = .1, print_every = 10,
